...
export default function ModifierDevisPage() {
  ...
  return (
    <div className="page-enter" style={{ flex: 1, padding: '40px', overflowY: 'auto', maxWidth: '800px' }}>
      <Link
        href={`/dashboard/chantiers/${chantierId}/devis/${devisId}`}
      ...
      <h1 style={{ fontFamily: 'var(--font-syne), sans-serif', fontSize: '24px', fontWeight: 700, color: '#F0EDE6', margin: '0 0 32px' }}>
        Modifier le devis <span style={{ color: '#F97316' }}>{form.numero}</span>
      </h1>
      ...
      <div style={{ backgroundColor: '#111110', border: '1px solid #1E1E1C', borderRadius: '12px', padding: '28px', marginBottom: '20px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
          ...
          <div style={{ gridColumn: '1 / -1' }}>
            ...
            <input type="text" value={form.client_nom} onChange={setField('client_nom')} style={inputStyle} onFocus={focus} onBlur={blur} placeholder="Nom du maître d'ouvrage" />
          </div>
