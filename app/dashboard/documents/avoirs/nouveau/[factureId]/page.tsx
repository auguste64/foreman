...
export default function NouvelAvoirPage() {
  ...
  return (
    <div className="page-enter" style={{ flex: 1, padding: '40px', overflowY: 'auto', maxWidth: 800 }}>
      <Link href={`/dashboard/documents/factures/${factureId}`} style={{ fontSize: 13, color: '#8A8880', textDecoration: 'none', fontFamily: 'var(--font-dm-sans), sans-serif', display: 'inline-flex', alignItems: 'center', gap: 6, marginBottom: 28 }}>
