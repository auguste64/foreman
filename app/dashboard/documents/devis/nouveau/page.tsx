...
export default function NouveauDevisPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      router.push(`/dashboard/documents/devis/${id}`)
    } catch (err: unknown) {
  ...
  return (
    <div className="page-enter" style={{ flex: 1, padding: '40px', overflowY: 'auto' }}>
      <Link href="/dashboard/documents" style={{ fontSize: 13, color: '#8A8880', textDecoration: 'none', fontFamily: 'var(--font-dm-sans), sans-serif', display: 'inline-flex', alignItems: 'center', gap: 6, marginBottom: 28 }}>
          ...
          <Card title="Informations">
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              <div>
                ...
                <input type="date" value={form.date_validite} onChange={set('date_validite')} onFocus={focus} onBlur={blur} style={{ ...inputStyle, colorScheme: 'dark' }} />
              </div>
            </div>
          </Card>
