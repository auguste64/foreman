...
export default function DevisDetailPage() {
  ...
  return (
    <div className="page-enter" style={{ flex: 1, padding: '40px', overflowY: 'auto', maxWidth: 900 }}>
      <Link href="/dashboard/documents" style={{ fontSize: 13, color: '#8A8880', textDecoration: 'none', fontFamily: 'var(--font-dm-sans), sans-serif', display: 'inline-flex', gap: 6, alignItems: 'center', marginBottom: 24 }}>
